...
import 'all_captain_screen/add_new_captain_screen/add_new_captain_screen.dart';
import 'all_captain_screen/all_captain_screen.dart';
            ...
            body: Column(
              children: [
                UserAccountsDrawerHeader(
                  accountName: Text(userApiResponse?.franchise?.name ?? ""),
                  accountEmail: Text(
                    userApiResponse?.franchise?.email ?? "",
                  ...
                  currentAccountPicture: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: "${ApiConstants.baseUrl}${userApiResponse?.franchise?.avatar ?? "${ApiConstants.baseUrl}/assets/others/franchise.png"}",
                        fit: BoxFit.fill,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        title: const Text("Add New Captain"),
                        onTap: () {
                          Nav.push(context, const AllCaptainScreen());
                        },
                      ),
                      ListTile(
                        leading: const Icon(Icons.settings),
