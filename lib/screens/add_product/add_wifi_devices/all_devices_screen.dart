...
import '../../../bloc/captain_device_cubit/captain_devices_cubit.dart' hide LoadingState;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<AllDevicesCubit, AllDevicesState>(
      listener: (context, state) {
        ...
        if (state is AddDeviceSuccessfully) {
