...
class AddDataSimScreen extends StatefulWidget {
  const AddDataSimScreen({Key? key}) : super(key: key);

  @override
  State<AddDataSimScreen> createState() => _AddDataSimScreenState();
}

class _AddDataSimScreenState extends State<AddDataSimScreen> {
  ...
  Future<void> _onDoneButtonPressed(BuildContext context) async {
    ...
    if (package!.isEmpty) {
      ...
      context.read<AddNewSimCubit>().addNewSim(
          ...
          simType: "data",
          numberType: typeValue!,
          price: _priceTextController.text,
          packageId: package!);
    }
  }

  _showDialog(DataPackages value) {
    return showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => AddNewSimCubit()..allDataSimPackages(),
      child: BlocConsumer<AddNewSimCubit, AddNewSimState>(
        listener: (context, state) {
          ...
          if (state is AllDataPackagesGetSuccessfully) {
            packages.clear();
        ...
        builder: (context, state) {
          return LoadingScreenAnimation(
            ...
            child: Scaffold(
              appBar: AppBar(
                title: const Text('Add New Data Sim'),
              ),
