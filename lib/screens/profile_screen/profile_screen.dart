                      ...
                      children: [
                          ...
                          children: [
                            ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: "${ApiConstants.baseUrl}${userApiResponse?.franchise?.avatar ?? "/assets/others/franchise.png"}" ,
                                  height: 150,
                                  width: 150,
                                  fit: BoxFit.fill,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(userApiResponse?.franchise?.name ?? ""),
                          ],
                        ),
                        const SizedBox(
                          height: 20,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(userApiResponse?.franchise?.email ?? ""),
                          ],
                        ),
                        const SizedBox(
                          height: 20,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text("${userApiResponse?.franchise?.phone}"),
                          ],
                        ),
                        const SizedBox(
                          height: 20,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                                child: Text(
                              userApiResponse?.franchise?.address ?? "",
                              maxLines: 5,
                            )),
                          ],
                        ),
