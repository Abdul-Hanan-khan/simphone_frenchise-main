...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    ...
    city = '';
    registrationAddress = '';
    currentRegistrationAddress = widget.userApiResponse?.franchise?.address ?? "";
    currentCity = '';
    // profileImage = widget.userApiResponse?.avatar;
    _nameTextController.text = widget.userApiResponse?.franchise?.name ?? "";
    _phoneTextController.text = widget.userApiResponse?.franchise?.phone ?? "";
    super.initState();
  }
