...
class SignUpPostApi {
  ...
  Future<SignUpApiResponse> franchiseSignUpRequest({String ?name,String ?email,String ?phone,String ?password,String ?address,String ?lat,String ?long,XFile ?avatarFile,}) async {
   Uri _uri= Uri.parse(ApiConstants.signUp);
    try {
      ...
      if(avatarFile !=null){
        http.MultipartFile multipartFile = await http.MultipartFile.fromPath('avatar', avatarFile!.path, );
